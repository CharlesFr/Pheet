...
$form = array(
	...
	'email' => array(
		'from' => 'Design@Charlesfried.com',
		'to' => 'Design@Charlesfried.com'
	),
	'fields' => array(
		'Email' => array(
			'order' => 1,
			'type' => 'email',
			'label' => 'Enquire about Pheet',
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Enquire about Pheet\' is required.',
				'format' => 'Field \'Enquire about Pheet\' has an invalid email address.'
			)
		)
	)
);
